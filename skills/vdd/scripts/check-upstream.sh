#!/usr/bin/env bash
# VDD freshness check — compares local skill against upstream gist.
...
ASSET_FILE="$SKILL_DIR/assets/upstream-method.md"
...
echo -e "${GREEN}Done${NC}: assets/upstream-method.md synced, SKILL.md updated"
