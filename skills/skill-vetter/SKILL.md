...
name: skill-vetter
description: >
  Pre-install security vetting for agent skills using a structured red-flag checklist.
  Checks metadata, permission scope, typosquatting, obfuscated content, and command injection.
  Produces a vetting report with verdict (Safe/Warning/Danger/Block).
  Use before installing any skill from external sources.
tags:
  - security
  - vetting
  - skill-review
...
metadata:
  version: "1.0.0"
  source-repo: "https://github.com/useai-pro/openclaw-skills-security"
  source-ref: "main"
  installed-from: "npx-skills"
  weekly-installs: "15.2K"
...
2. Skills verified by known organizations
